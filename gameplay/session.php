...
if(isset($_SESSION['user'])){
    if ($u['blokir'] == 1) {
        // Pengguna diblokir, arahkan ke halaman sebelumnya dengan pesan notifikasi
        echo "<script>alert('Akun Anda Sedang Dalam Masa Promosi Silahkan Menghubungi Admin/Livechat');</script>";
        echo "<script>window.history.back();</script>";
        exit;
    } else {
        // Pengguna tidak diblokir, lanjutkan dengan logika aplikasi
    }
}
?>
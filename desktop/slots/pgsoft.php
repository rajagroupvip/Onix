           ...
           <div class="row no-gutters text-center slider-content"  >
             <!--//hardcoded links.......-->
                ...
                <div class="col"  >
                   ...
                   <a   class="btn-box active" href="<?php echo $urlweb; ?>/desktop/slots/pgsoft" rel="opener"  >
     ...
     <div class="container sub-games">
       ...
       <br />
        ...
        <?php
          ...
          $where = "`game_provider` = 'pgsoft'";
          $pageLink = 'slot/?';
          
          $sql_3 = mysqli_query($conn, "SELECT * FROM `tb_gamenew` WHERE $where ") or die(mysqli_error($conn));
          while($s3 = mysqli_fetch_array($sql_3)){
            ...
            <div class="game-box text-center" data-jpid="" data-title="<?php echo $s3['game_name']; ?>"
                ...
                <div class="image">
                    <!-- [delayMsec]="1500"-->
                    <img src="" data-src="<?php echo $s3['game_image']; ?>"

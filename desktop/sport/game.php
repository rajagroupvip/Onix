...
<div class="content my01">
                ...
                <div class="left"><button class="prev-btn btn" id="left-button"><i
                    ...
                    if ($result) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo '<div class="col">';
                            echo '<a class="btn-box" href="/desktop/sport/game/?provider=' . $row['provider_code'] . '" rel="opener">';
    ...
    <div class="container sub-games">
        <div class="">
            ...
            $sql_3 = mysqli_prepare($conn, "SELECT * FROM `game_list` WHERE $where AND game_type = 'sb'");

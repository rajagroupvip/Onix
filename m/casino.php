...
$providerCode = isset($_GET['provider']) ? $_GET['provider'] : 'pr';
...
<div class="container pt-1 sub-games">
    ...
    <?php
        ...
        $sql_3 = mysqli_query($conn, "SELECT * FROM `game_list` WHERE $where and game_type ='lc' and game_status =1") or die(mysqli_error($conn));

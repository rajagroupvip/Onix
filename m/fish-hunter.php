...
$providerCode = isset($_GET['provider']) ? $_GET['provider'] : 'FG';
...
<div class="container pt-1 sub-games">
    <div>
        ...
        <div class="scroll-wrapper row" style="height:72px;">
            ...
            <div class="left"><button class="prev-btn btn" id="left-button"><i
                        ...
                        $query = "SELECT * FROM provider where provider_type ='FH' and provider_status = 1";
                        ...
                        if ($result) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo '<div class="col">';
                                echo '<a class="btn-box" href="/m/fishing/?provider=' . $row['provider_code'] . '" rel="opener">';
    ...
    <?php
        ...
        $sql_3 = mysqli_query($conn, "SELECT * FROM `game_list` WHERE $where and game_type ='fh' and game_status =1") or die(mysqli_error($conn));

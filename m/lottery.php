...
<div class="container pt-1 sub-games">
    <div>
        ...
        <div class="scroll-wrapper row" style="height:72px;">
            ...
            <div class="left"><button class="prev-btn btn" id="left-button"><i
                        ...
                        $query = "SELECT * FROM provider where provider_type ='LK' and provider_status = 1";
                        ...
                        if ($result) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo '<div class="col">';
                                echo '<a class="btn-box" href="/gameplay/opengame/?gamecode=' . $row['provider_code'] . '" rel="opener">';
    ...
    <?php
        ...
        $sql_3 = mysqli_query($conn, "SELECT * FROM `game_list` WHERE  game_type ='LK' and game_status =1") or die(mysqli_error($conn));
